...
public class PayLogServiceImpl extends ServiceImpl<PayLogMapper, PayLog> implements PayLogService {
    ...
    public Map createNative(String orderNo) {
        try {
            ...
            m.put("nonce_str", WXPayUtil.generateNonceStr());//随机字符串，使每个二维码都不一样
            m.put("body", order.getCourseTitle());//名称
            m.put("out_trade_no", orderNo);//订单ID
            ...
            m.put("trade_type", "NATIVE");//类型-根据价格生成二维码

            //3.发生httpclient请求，传递参数xml格式，微信支付提供的固定地址
